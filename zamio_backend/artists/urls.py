...
from artists.views.tracks_views import add_track, archive_track, delete_track, edit_track, get_all_archived_tracks_view, get_all_tracks_admin_view, get_all_tracks_view, get_edit_track_support_data_view, get_track_details_view, get_upload_track_support_data_view, unarchive_track, upload_track_cover_view, get_track_edit_history_view
...
# 
    ...
    path('get-edit-album-support-data/', get_edit_album_support_data_view, name='get_edit_album_support_data_view'),
    ...
    path('get-album-edit-history/', get_album_edit_history_view, name='get_album_edit_history'),
# 
    # # 🎵 Tracks
    ...
    path('get-track-edit-history/', get_track_edit_history_view, name='get_track_edit_history'),
# 
    # # 👥 Contributors
    ...
    path('get-track-split-summary/', get_track_split_summary, name='get_track_split_summary'),
    path('auto-balance-track-splits/', auto_balance_track_splits, name='auto_balance_track_splits'),
    path('bulk-update-contributor-splits/', bulk_update_contributor_splits, name='bulk_update_contributor_splits'),
# 
